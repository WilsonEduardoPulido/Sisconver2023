...
namespace App\Http\Livewire\ComponenteLibros;

use App\Models\ModeloLibro\Libro;
use App\Models\ModeloNovedades\Novedades;
...
class Libros extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.libros.libros', compact('categorias','consulta','consultaUsuariosLibros','libros'));
