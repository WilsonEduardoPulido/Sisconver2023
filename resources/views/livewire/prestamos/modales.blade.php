...
<div wire:ignore.self class="modal modal-xl fade" id="finalirestamoModal" data-bs-backdrop="static"
            ...
            <div class="modal-body">
                ...
                <div class=" d-flex  m-auto">
                    ...
                    <div class="col-6 bg-primary">
                        ...
                        <form class="" wire:submit.prevent="enviarDatosDevolucion" id="#DevolucionElemento">
                            <div class="">
                            ...
                            <div class="">
                                ...
                                <input type="number" class="form-control " id="validationServer01" value="Mark"
                                    required wire:model="CantidadDevuelta">
                                <div class="valid-feedback">
                                    Looks good!
                                </div>
                            </div>
