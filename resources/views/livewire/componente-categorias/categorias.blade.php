              ...
              <div class="col-md-12 ">
                  ...
                  <div class="tab-content" id="pills-tabContent">
                      ...
                      <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                          ...
                          @include('livewire.componente-categorias.TablaPrincipal')
                      </div>
                      <!----------- FIN CONTENEDOR 1  ------------->
                      ...
                      <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab"
                          tabindex="0">
                          @include('livewire.componente-categorias.TablaRestaurarCategorias')
                      </div>
                      <!----------- FIN CONTENEDOR 2  ------------->
                  ...
                  @include('livewire.componente-categorias.modales')
